      ...
      <div className="max-w-4xl mx-auto">
        <div className="bg-white/10 backdrop-blur-md rounded-xl p-8 border border-white/20">
          ...
          <div className="prose prose-invert max-w-none space-y-6 text-slate-200">
            <p>
              Welcome to Castd ("App"), operated by [Your Company Name] ("we,"
              "us," or "our"). By accessing or using Castd, you agree to these
              Terms & Conditions ("Terms"). If you do not agree, do not use the
              App.
            </p>
            ...
            <section>
              ...
              <ul className="space-y-2 list-disc list-inside">
                <li>
                  ...
                  consent age in your country) to use Reel Friends.
                </li>
                <li>
                  By using the App, you represent that you meet this
                  requirement.
                </li>
              </ul>
            </section>
            ...
            <section>
              ...
              <div className="space-y-3">
                <div>
                  ...
                  <p>
                    You retain ownership of the content you create or share. By
                    submitting content, you grant us a worldwide, non-exclusive,
                    royalty-free license to use, display, and distribute it
                    inside the App for functionality.
                  </p>
                </div>
                <div>
                  <h3 className="font-semibold text-white">Our Content:</h3>
                  <p>
                    All trademarks, branding, software, and design belong to us.
                    You may not copy or use them without permission.
                  </p>
                </div>
              </div>
            </section>
            ...
            <section>
              ...
              <ul className="space-y-2 list-disc list-inside">
                <li>
                  We may use your data to show you advertising only inside the
                  App (never sold to third parties).
                </li>
                <li>
                  We may send you emails about account updates, changes to these
                  Terms, or marketing. You may opt out of marketing but not
            ...
            <section>
              ...
              <p>
                ...
                reliability, accuracy, or availability. Use is at your own risk.
              </p>
            </section>
            ...
            <section>
              ...
              <ul className="space-y-2 list-disc list-inside">
                <li>
                  ...
                  consequential, special, or exemplary damages of any kind
                  whatsoever arising from your use or inability to use the App.
                </li>
                <li>
                  We will not be responsible for any losses, claims, or costs,
                  and we will not pay anything out of pocket under any
                  circumstance.
                </li>
                <li>
                  You agree that your sole and exclusive remedy for any issue
                  with the App is to stop using it.
                </li>
              </ul>
            </section>
            ...
            <section>
              ...
              <p>
                ...
                damages, or expenses (including attorneys' fees) related to your
            ...
            <section>
              ...
              <p>
                ...
                reason, without notice. After termination, your right to use the
            ...
            <section>
              ...
              <p>
                ...
                e.g., Florida, USA], without regard to conflict-of-law
            ...
            <section>
              ...
              <p>
                We may update these Terms at any time. We'll notify you by email
                or in-App notice. Continued use after changes means you accept
                the new Terms.
              </p>
            </section>
          </div>
