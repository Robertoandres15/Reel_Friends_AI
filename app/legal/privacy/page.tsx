        ...
        <div className="flex items-center gap-4 mb-8">
          ...
          <div>
            ...
            <p className="text-slate-400 mt-1">
              Effective Date: 9/1/2025 | Last Updated: 9/1/2025
            </p>
          </div>
        </div>
          ...
          <div className="space-y-8">
            <section>
              ...
              <div className="text-slate-300 space-y-3">
                ...
                <ul className="list-disc list-inside space-y-2 ml-4">
                  ...
                  <li>
                    <strong>Usage Information:</strong> Movies you search, lists
                    you create, and in-app activity.
                  </li>
                  <li>
            ...
            <section>
              ...
              <div className="text-slate-300 space-y-3">
                ...
                <ul className="list-disc list-inside space-y-2 ml-4">
                  ...
                  <li>
                    Personalize your in-app experience, including showing ads
                    only within the app.
                  </li>
                  <li>
                    Send you service-related emails (account updates, security
                    notices).
                  </li>
                  <li>
                    Send you promotional emails about new features and offers
            ...
            <section>
              ...
              <div className="text-slate-300 space-y-3">
                ...
                <ul className="list-disc list-inside space-y-2 ml-4">
                  <li>
                    Service providers who help us operate the App (e.g., cloud
                    hosting, analytics).
                  </li>
            ...
            <section>
              ...
              <p className="text-slate-300">
                We retain your information as long as you maintain an account.
            ...
            <section>
              ...
              <p className="text-slate-300">
                We use reasonable safeguards (encryption, access controls) to
                protect your information, but no system is 100% secure.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-slate-300">
                ...
                [Insert Email] to exercise these rights.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-slate-300">
                ...
                are material, we will notify you by email or in-app notice.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-slate-300">
                ...
                <a
                  href="mailto:wittysticker@gmail.com"
        ...
        <div className="mt-12 pt-8 border-t border-slate-700">
          <div className="flex justify-between items-center">
            <p className="text-slate-400 text-sm">
              © 2026 Witty Stickers LLC. All rights reserved
            </p>
            {!isFromSignup && (
              <Button
                variant="outline"
