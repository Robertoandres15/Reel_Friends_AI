  ...
  const handleSignUp = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (
        ...
        error.message.includes("Your project's URL and API key are required")
      ) {
        setError(
            ...
            <form onSubmit={handleSignUp}>
              ...
              <div className="flex items-start space-x-2 mt-4">
                ...
                <div className="grid gap-1.5 leading-none">
                  ...
                  >
                        ...
                        <ScrollArea className="h-[60vh] pr-4">
                          <div className="text-slate-300 space-y-4 text-sm">
                            ...
                            <p>
                              ...
                              confidentiality of your account and password and
                            ...
                            <p>
                              Users must not post content that is illegal,
                            ...
                            <p>
                              The information on this service is provided on an
                              "as is" basis. To the fullest extent permitted by
                              law, this Company excludes all representations,
                    ...
                    and{" "}
                    <Link
                      href="/legal/privacy?from=signup"
                      className="text-purple-400 hover:text-purple-300 underline"
                    >
                      Privacy Policy
                    </Link>
              ...
              {error && error === "already_registered" ? (
                <div className="mt-4 p-4 bg-orange-500/10 border border-orange-500/20 rounded-lg">
                  <p className="text-orange-400 text-sm text-center mb-2">
